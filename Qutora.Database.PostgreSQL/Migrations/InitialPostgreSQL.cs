        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitializedByUserId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedProviderIds = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalTimeoutHours = table.Column<int>(type: "integer", nullable: false),
                    RequiredApprovalCount = table.Column<int>(type: "integer", nullable: false),
                    CategoryFilters = table.Column<string>(type: "text", nullable: true),
                    ProviderFilters = table.Column<string>(type: "text", nullable: true),
                    UserFilters = table.Column<string>(type: "text", nullable: true),
                    ApiKeyFilters = table.Column<string>(type: "text", nullable: true),
                    FileSizeLimitMB = table.Column<int>(type: "integer", nullable: true),
                    FileTypeFilters = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    IsGlobalApprovalEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    GlobalApprovalEnabledAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    GlobalApprovalEnabledByUserId = table.Column<string>(type: "text", nullable: true),
                    GlobalApprovalReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    DefaultExpirationDays = table.Column<int>(type: "integer", nullable: false),
                    DefaultRequiredApprovals = table.Column<int>(type: "integer", nullable: false),
                    ForceApprovalForAll = table.Column<bool>(type: "boolean", nullable: false),
                    ForceApprovalForLargeFiles = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    AllowDirectAccess = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmtpServer = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ...
                    LastTestEmailSentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastTestEmailStatus = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    FileTypes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    CategoryId = table.Column<Guid>(type: "uuid", nullable: false),
                    SchemaDefinitionJson = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ShareApprovalRequestId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareCode = table.Column<string>(type: "character varying(12)", maxLength: 12, nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    AllowPrint = table.Column<bool>(type: "boolean", nullable: false),
                    MaxViewCount = table.Column<int>(type: "integer", nullable: true),
                    WatermarkText = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    NotificationEmails = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CreatedViaApiKeyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RequiresApproval = table.Column<bool>(type: "boolean", nullable: false),
                    ApprovalStatus = table.Column<int>(type: "integer", nullable: false),
                    IsDirectShare = table.Column<bool>(type: "boolean", nullable: false),
                    ApprovalToken = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RejectionToken = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IsApprovalTokenUsed = table.Column<bool>(type: "boolean", nullable: false),
                    IsRejectionTokenUsed = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    UpdatedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetadataSchemaId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewerIP = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DocumentShareId = table.Column<Guid>(type: "uuid", nullable: false),
                    ApprovalPolicyId = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    RequestReason = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    FinalComment = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    RequestedByUserId = table.Column<string>(type: "text", nullable: false),
                    RequiredApprovalCount = table.Column<int>(type: "integer", nullable: false),
                    CurrentApprovalCount = table.Column<int>(type: "integer", nullable: false),
                    AssignedApprovers = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApprovalDecisions_ShareApprovalRequests_ShareApprovalReques~",
                table: "ApprovalDecisions",
                column: "ShareApprovalRequestId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApprovalHistories_ShareApprovalRequests_ShareApprovalReques~",
                table: "ApprovalHistories",
                column: "ShareApprovalRequestId",
                principalTable: "ShareApprovalRequests",
                principalColumn: "Id",
